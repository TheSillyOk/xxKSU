...
- static_assert on fn ptr (e.g. static_assert(!!&kernel_read);) on clang < 14? fails. compiler thinks it has to prove constness, it works like static_assert(__builtin_constant_p(expr))
